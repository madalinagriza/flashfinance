...
content_id: 2ea91399f37920accf643330b9674db456a7b3075f602d2ec2e34396e07d828a
---
...
\#prompt:  cateogry update times out. why

🚀 Requesting server listening for POST requests at base path of /api/\*
Listening on http://localhost:8000/ (http://localhost:8000/)
\[Requesting] Received request for path: /Label/update

Requesting.request {
session: '019a5f3f-098b-7e5d-86d2-9d1bb9d2cdab',
tx\_id: 'd0f5a9c1-7c69-40fa-8466-80712081382e',
new\_category\_id: 'c10b2392-5111-4544-a446-f16804627de8',
path: '/Label/update'
} => { request: '019a5f3f-61d2-7f74-a8d3-0c00fdc561e8' }

\[Requesting] Error processing request: Request 019a5f3f-61d2-7f74-a8d3-0c00fdc561e8 timed out after 10000ms
