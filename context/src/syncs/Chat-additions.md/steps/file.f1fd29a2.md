...
content_id: f1fd29a28a7ace041ea1a6e9a0ccbf9a0c3812c9f5f3658284f12e0628624cb0
---
...
> **discardUnstagedLabel**(user\_id : ID, tx\_id : ID, tx\_name : String, tx\_merchant : String)  : (label\_tx\_id : ID)
>
> > *requires:*
> > no committed label exists for `tx_id`;  no stagedLabel with ID tx\_id.
> > *effects:*\
...
> **removeCommittedLabel**(user\_id : ID, tx\_id : ID)
>
> > *requires:*\
> > a label for `tx_id` exists; `transaction.owner_id = user_id`\
> > *effects:*\
