...
parent: '[[..\20251017_201613.bc5d715c.md]]'
content_id: 8c0bbe74601e11a0a44ce7fccabdbb829f95592417a4fadc25ff86e660fe7857
---

# prompt: the interface of the label has change a bit in terms of the getters also taking in an user as well. additionally, the keys in the database have now a combined form of user and transactions. In the places where this is relevant, modify test-op-simple such that it complies with the calls. Make very minimal changes, while keeping the functionality correct.
