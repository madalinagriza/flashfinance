...
parent: '[[..\20251017_191052.e1faf1fe.md]]'
content_id: 19bce776b6265b29ff584080fd8480c6c76d21b6eb5048f09fe1482618c917aa
---

# prompt:  I just updated the spec so that instead of doing the action apply (which writes to the history right away), it introduces a pending status. The finalize action takes all the pending stages and does what apply implements, except for all the pendingLabels. Please update label.ts accordingly, making minimal changes and adding the actions cancel, stage, finalize
