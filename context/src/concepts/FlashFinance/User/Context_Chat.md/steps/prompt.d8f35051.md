---
timestamp: 'Fri Oct 17 2025 22:38:24 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251017_223824.951453dc.md]]'
content_id: d8f350512400bfbe1ab60662b982018ba728d67734aaffb335e974e4e339b5f6
---

# prompt:   implement the state for the user spec. use label.ts to consult imports and structure. draw from existing knowledge how to implement user concepts. Keep it simple, minimal, and just the amounts that we need. Don't implement any actions, just the state.
