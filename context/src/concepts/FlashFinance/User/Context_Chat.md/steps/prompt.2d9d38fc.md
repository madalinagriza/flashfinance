...
content_id: 2d9d38fcfc780c4161ba6ec0414cc5fc42a367daab8c148fbf775fed5f46ed77
---

# prompt:  # iterate on the user's test-op-simple.ts file and implement the authentificate action. Implement *only* authentificate  and helper functions that you deem necessary. Be minimal in your coding, but ensure you satisfy everything that is stated in the register action in the spec
