...
content_id: 77f7179733ff7ed6e52973b22fbce4f0d7451c9e049c3ec181d7418e6723b2d0
---
...
> importTransactions(owner\_id: ID, file\_id: ID): (txs: \[Transactions])
>
> > *requires:* owner exists; file id is valid\
> > *effects:* parses the files and converts rows into Transactions owned by owner\_id with status UNLABELED; generates new tx\_ids for each transaaction; adds them to state; returns the created list
