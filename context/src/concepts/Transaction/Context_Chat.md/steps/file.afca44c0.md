...
content_id: afca44c04a1ab3e5a4fab028b5bc5839659f3f3d40a6390050b1100009d35fa2
---

# file: src/concepts/Transaction/test-actions/test-parsing-edge-cases.ts
...
Deno.test("TransactionConcept: import_transactions handles empty CSV content", async () => {
  let db: Db | null = null;
...
Deno.test("TransactionConcept: import_transactions handles CSV with only headers", async () => {
  let db: Db | null = null;
  let client: MongoClient | null = null;
...
Deno.test("TransactionConcept: import_transactions skips CSV rows with only inflows", async () => {
  let db: Db | null = null;
  let client: MongoClient | null = null;
...
`;
    ...
    await store.import_transactions(ownerId, content);
    const allStoredTransactions = await store.list_all();
...
Deno.test("TransactionConcept: import_transactions handles mixed valid and invalid rows from testsample.csv", async () => {
  let db: Db | null = null;
  let client: MongoClient | null = null;
...
Deno.test("TransactionConcept: import_transactions skips rows when essential amount columns are missing", async () => {
  let db: Db | null = null;
  let client: MongoClient | null = null;
...
Deno.test("TransactionConcept: import_transactions rejects falsy owner_id", async () => {
  let db: Db | null = null;
  let client: MongoClient | null = null;
