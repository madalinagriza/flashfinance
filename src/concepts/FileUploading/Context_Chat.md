[@FileUploadingConcept.ts](FileUploadingConcept.ts)

[@FileUploadingDirections](FileUploadingDirections.md)

[@concept-background](../../../design/tools/concept-background.md)

[@TransactionConcept.ts](../Transaction/TransactionConcept.ts)
